...
const pipeRoughnessData = {
  ...
  source:
    "Perry's Chemical Engineers' Handbook, Table 6-7; Valeurs de référence du diagramme de Moody",
  reference_url: 'https://fluids.readthedocs.io/fluids.friction.html',
  notes:
    "Ces valeurs sont utilisées pour calculer la rugosité relative (ε/D) et le facteur de friction dans l'équation de Darcy-Weisbach",
  unites: {
