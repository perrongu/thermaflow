...
**Référence complète**: Perry, R.H., Green, D.W., Maloney, J.O. (2016). *Perry's Chemical Engineers' Handbook*, 9th Edition. McGraw-Hill.
...
**Référence**: Wagner, W., Kretzschmar, H.J. (2008). *International Steam Tables - Properties of Water and Steam based on the Industrial Formulation IAPWS-IF97*. Springer.
...
**Référence**: Bell, C. (2016-2024). *fluids: Fluid dynamics component of Chemical Engineering Design Library*. Open-source Python library.
...
**Référence**: ASHRAE (2021). *ASHRAE Handbook - Fundamentals*. American Society of Heating, Refrigerating and Air-Conditioning Engineers.

**Utilisation**: Propriétés thermiques matériaux isolants

### 5. Incropera & DeWitt - Fundamentals of Heat and Mass Transfer

**Référence**: Bergman, T.L., Lavine, A.S., Incropera, F.P., DeWitt, D.P. (2017). *Fundamentals of Heat and Mass Transfer*, 8th Edition. Wiley.
...
- Churchill, S.W. (1977). "Friction-Factor Equation Spans All Fluid-Flow Regimes". *Chemical Engineering*, Nov. 7, 1977, pp. 91-92.
...
- Dittus, F.W., Boelter, L.M.K. (1930). *University of California Publications in Engineering*, Vol. 2, p. 443. University of California Press.
...
Version 1.0.0. Disponible: https://github.com/perrongu/thermaflow
```
...
> "Le facteur de friction a été calculé avec la corrélation de Colebrook-White (Perry's Handbook Section 6-4) en utilisant le logiciel ThermaFlow v1.0.0."
