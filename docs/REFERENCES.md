...
Version 1.1.3. Disponible: https://github.com/perrongu/thermaflow
```
...
> "Le facteur de friction a été calculé avec la corrélation de Colebrook-White (Perry's Handbook Section 6-4) en utilisant le logiciel ThermaFlow v1.1.3."
